import { Shield, Heart, Zap, ShieldCheck, Sparkles, Footprints, Eye, Swords, Target, Activity, BookOpen } from 'lucide-react';
...
export const FILTER_DEFINITIONS: FilterConfig[] = [
  ...
  // Source Books
  {
    ...
    type: 'multiSelect',
    icon: BookOpen,
    category: FILTER_CATEGORIES.SOURCES,
    searchable: true,
    excludeMode: true,
    priority: 5,
    getValue: (creature) => creature.sources?.map((s: any) => s.name) || []
  },
